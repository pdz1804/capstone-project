...
class TextSearchService:
    ...
    def search_dense(self, query: str, top_k: int) -> List[Dict[str, Any]]:
        ...
        for rank, hit in enumerate(raw, start=1):
            ...
            text = base.get("text") or pl.get("text_preview") or ""
            results.append(
                {
                    "id": cid,
    ...
    def search_hybrid(self, query: str, top_k: int) -> List[Dict[str, Any]]:
        ...
        if self._reranker_model and out:
    ...
    def search(self, query: str, retriever_type: str, top_k: int) -> List[Dict[str, Any]]:
