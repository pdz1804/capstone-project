...
Recent RAG systems increasingly decide when, what, and how much to retrieve. FLARE, Adaptive-RAG, SEAKR, and DRAGIN trigger or route retrieval dynamically~\cite{flare2023, adaptive_rag2024, seakr2024, dragin2024}. SELF-RAG, CRAG, and CoV-RAG add critique, filtering, refusal, or verification to reduce unsupported generation~\cite{asai2023selfrag, crag2024, covrag2024, lmpriors2024}. Context compression and ranking became central through RankRAG and LLMLingua~\cite{rankrag2024, llmlingua2023, compression2024}, while GraphRAG/GRAG introduced structure-aware retrieval over entities and relationships~\cite{graphrag2024, grag2024}. LongRAG and self-routing explored how long-context LLMs and targeted retrieval can be combined~\cite{longrag2024, selfroute2024}.
