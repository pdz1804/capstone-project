...
\begin{itemize}
    ...
    \item \textbf{Chapter 8: Appendices} – Provides supplementary materials including system interfaces, database schemas, API specifications, and team contributions.
\end{itemize}
