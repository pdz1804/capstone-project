...
\begin{itemize}
    ...
    \item \textbf{Chapter 5: Implementation} – Details the technical setup, multi-tenant cloud-native architecture, and database schemas.
    \item \textbf{Chapter 6: Evaluation Methods} – Defines the metrics, datasets, and procedures used to evaluate system performance.
    \item \textbf{Chapter 7: Conclusion} – Summarizes achievements and outlines long-term development strategies.
\end{itemize}
