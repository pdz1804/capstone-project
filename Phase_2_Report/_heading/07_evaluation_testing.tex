...
\begin{table}[!ht]
    ...
    \begin{tabular}{lrrrrr}
        ...
        Read Order & 92.60\% & 15\% & Exceptionalâ€”preserves logical flow in complex layouts \\
...
\textbf{BM25 (Sparse Retrieval) â€” Full Metrics}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{lrr}
        ...
        \midrule
        Recall@1 & 23.83\% & Â±24.23\% \\
        Recall@3 & 46.98\% & Â±27.21\% \\
        Recall@5 & 69.66\% & Â±20.26\% \\
        Recall@10 & 100.0\% & Â±0.00\% \\
        \midrule
        nDCG@1 & 76.67\% & Â±38.87\% \\
        nDCG@3 & 67.96\% & Â±30.79\% \\
        nDCG@5 & 74.89\% & Â±22.67\% \\
        nDCG@10 & \textbf{84.84\%} & Â±16.74\% \\
        \bottomrule
    \end{tabular}
    }
\end{table}

\textbf{Dense (Semantic Retrieval) â€” Full Metrics}

\begin{table}[!ht]
    \centering
    \caption{Dense Retrieval Performance (All K Values with Standard Deviation)}
    ...
    \begin{tabular}{lrr}
        ...
        \textbf{Metric} & \textbf{Mean} & \textbf{Std Dev} \\
        \midrule
        Recall@1 & 24.62\% & Â±24.90\% \\
        Recall@3 & 50.05\% & Â±31.33\% \\
        Recall@5 & 70.85\% & Â±24.72\% \\
        Recall@10 & 100.0\% & Â±0.00\% \\
        \midrule
        nDCG@1 & 66.67\% & Â±42.16\% \\
        nDCG@3 & 65.81\% & Â±33.28\% \\
        nDCG@5 & 70.82\% & Â±25.64\% \\
        nDCG@10 & \textbf{81.92\%} & Â±18.56\% \\
        \bottomrule
    \end{tabular}
    }
\end{table}
...
\textbf{BM25 Image Retrieval â€” Full Metrics}

\begin{table}[!ht]
    \centering
    \caption{BM25 Image Retrieval Performance (All K Values with Standard Deviation)}
    ...
    \begin{tabular}{lrr}
        ...
        \textbf{Metric} & \textbf{Mean} & \textbf{Std Dev} \\
        \midrule
        Recall@1 & 22.95\% & Â±33.59\% \\
        Recall@3 & 38.86\% & Â±35.16\% \\
        Recall@5 & 53.84\% & Â±36.89\% \\
        Recall@10 & 80.00\% & Â±40.00\% \\
        \midrule
        nDCG@1 & 56.67\% & Â±46.67\% \\
        nDCG@3 & 54.95\% & Â±38.03\% \\
        nDCG@5 & 58.66\% & Â±37.30\% \\
        nDCG@10 & \textbf{67.14\%} & Â±37.25\% \\
        \bottomrule
    \end{tabular}
    }
\end{table}

\textbf{Dense Image Retrieval â€” Full Metrics}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{lrr}
        ...
        \textbf{Metric} & \textbf{Mean} & \textbf{Std Dev} \\
        \midrule
        Recall@1 & 17.67\% & Â±26.27\% \\
        Recall@3 & 34.50\% & Â±33.05\% \\
        Recall@5 & 48.23\% & Â±34.54\% \\
        Recall@10 & 77.50\% & Â±41.76\% \\
        \midrule
        nDCG@1 & 51.67\% & Â±47.11\% \\
        nDCG@3 & 49.10\% & Â±37.62\% \\
        nDCG@5 & 54.30\% & Â±36.14\% \\
        nDCG@10 & \textbf{62.58\%} & Â±37.35\% \\
        \bottomrule
    \end{tabular}
    }
\end{table}

\textbf{Image Modality Analysis}

Image retrieval achieves 77.5\%--80.0\% recall@10 across strategies, indicating that most relevant pages are found within top 10 results. However, top-1 performance is substantially lower than text retrieval (17.67\%--22.95\% vs 23.83\%--24.62\%), suggesting visual-only retrieval is less precise for direct lookups. This is expected: text retrieval can locate pages via heading/content keywords, while image retrieval must match visual patterns (tables, charts, diagrams), which is inherently more ambiguous without additional context. The 17\%--23\% nDCG@10 gap between text (81.92\%--84.84\%) and image (62.58\%--67.14\%) modalities indicates that text is the primary retrieval signal. Image retrieval excels as a complementary modality when users specifically search for visual patterns that are difficult to locate via text alone.

\textbf{Media (Video/Audio) Evaluation}

Media parsing was evaluated on 42 MIT lecture videos (MITFLD subset, under 100MB each). The pipeline extracted audio, ran Whisper ASR for transcription, chunked transcripts temporally, and extracted frames at 100-frame intervals.
...
ASR quality is good: 16.63\% WER (word error rate) is typical for Whisper tiny on CPU and acceptable for educational lecture retrieval. Temporal coverage is excellent (100\% hit rate for chunk recall), though temporal precision is moderate (34.84\% Temporal IoU), meaning chunks often span broader time windows than the exact targetâ€”acceptable for content retrieval but limiting for sub-minute precision seeking. Frame extraction succeeded on all 42 videos with proper timestamp metadata, enabling visual-temporal retrieval for video content.
...
\subsection{System-Level Evaluation: Chunking and End-to-End RAG}
...
\begin{table}[!ht]
    \centering
    \caption{End-to-End RAG Performance (660 Questions)}
...
\begin{itemize}
    \item \textbf{Participant Pool}: 10â€“20 HCMUT students across multiple courses and academic levels
    \item \textbf{Study Duration}: One full semester (13â€“15 weeks) of real-world usage in a course setting
...
The three dimensions of Phase 2 validationâ€”component-level evaluation, operational performance testing, and cost estimationâ€”converge on a clear assessment: \textbf{BK-MInD is ready for pilot deployment} with identified optimization targets and infrastructure priorities.
