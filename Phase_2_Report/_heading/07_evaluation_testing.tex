...
\begin{table}[H]
    ...
    \begin{tabular}{llrrrrr}
        ...
        \midrule
        \textbf{Upload API} & 20 users & 0.0 & 2,810.4 & 2,410 & 4,120 & 4,450 \\
        & 30 users & 0.0 & 3,842.1 & 3,550 & 5,821 & 6,102 \\
        & 40 users & 0.0 & 4,912.4 & 4,210 & 7,931 & 8,245 \\
...
\subsubsection{Asynchronous Pipeline and Indexing Performance}

The asynchronous processing and vector indexing pipelines are measured by their success rates and total job durations.

\begin{table}[H]
    \centering
    \caption{Asynchronous Pipeline and Indexing Performance Matrix}
    \label{tab:pipeline_perf}
    \scalebox{0.85}{
    \begin{tabular}{lrrrr}
        \toprule
        \textbf{Workflow} & \textbf{Concurrency} & \textbf{Success Rate} & \textbf{Avg Duration (s)} & \textbf{P95 (s)} \\
        \midrule
        \textbf{Document Processing} & 20 jobs & 80.0\% & 36.2 & 38 \\
        & 30 jobs & 83.3\% & 41.5 & 44 \\
        & 40 jobs & 72.5\% & 50.8 & 56 \\
        \midrule
        \textbf{Full Indexing} & 20 jobs & 100.0\% & 98.1 & 106 \\
...
\subsubsection{Search and Chat Streaming Performance}

The following matrix details the performance of the hybrid search and the real-time chat assistant across escalating concurrency loads.

\begin{table}[H]
    \centering
    \caption{Search and Chat Performance Matrix}
    \label{tab:search_chat_perf_matrix}
    \scalebox{0.85}{
    \begin{tabular}{llrrrr}
        \toprule
        \textbf{Service} & \textbf{Concurrency} & \textbf{Mean (ms)} & \textbf{P50 (ms)} & \textbf{P95 (ms)} & \textbf{P99 (ms)} \\
        \midrule
        \textbf{Search API} & 20 users & 18,412.3 & 17,901 & 24,102 & 25,110 \\
        & 30 users & 19,550.8 & 18,340 & 26,891 & 27,240 \\
        & 40 users & 20,119.2 & 19,821 & 28,410 & 28,901 \\
        & 50 users & 21,894.8 & 22,112 & 30,119 & 30,162 \\
        \midrule
        \textbf{Chat Stream} & 20 users & 34,102.1 & 32,841 & 42,109 & 44,120 \\
        (Full Request) & 30 users & 36,891.4 & 35,102 & 48,110 & 50,210 \\
        & 40 users & 41,201.7 & 45,102 & 55,210 & 58,110 \\
...
While full search and chat response times increase with concurrency, the chat assistant maintains a highly responsive first-byte latency of approximately 1.4 seconds. This ensures that users perceive the system as responsive even as the backend orchestrates complex retrieval and generation tasks.

\subsubsection{Learning Insight APIs Performance}

The system's pedagogical features, including summary generation, MCQ creation, and learning roadmap synthesis, were tested at a sustained load of 50 concurrent users.

\begin{table}[H]
    \centering
    \caption{Learning Insight APIs Performance Matrix}
    \label{tab:insight_perf_matrix}
    \scalebox{0.85}{
    \begin{tabular}{lrrrrr}
        \toprule
        \textbf{Endpoint} & \textbf{Concurrency} & \textbf{Error \%} & \textbf{Mean (ms)} & \textbf{P50 (ms)} & \textbf{P95 (ms)} \\
        \midrule
        \textbf{Summary API} & 20 users & 0.0 & 6,145.9 & 6,047 & 7,586 \\
        & 30 users & 0.0 & 6,248.3 & 6,205 & 7,398 \\
        & 40 users & 0.0 & 6,608.5 & 6,479 & 8,388 \\
        & 50 users & 0.0 & 6,866.9 & 6,745 & 8,295 \\
        \midrule
        \textbf{MCQ API} & 20 users & 0.0 & 3,358.7 & 3,290 & 4,355 \\
        & 30 users & 0.0 & 3,644.0 & 3,601 & 4,543 \\
        & 40 users & 0.0 & 3,835.2 & 3,759 & 5,052 \\
        & 50 users & 0.0 & 4,295.2 & 4,135 & 6,171 \\
        \midrule
        \textbf{Roadmap API} & 20 users & 0.0 & 2,507.2 & 2,439 & 3,588 \\
