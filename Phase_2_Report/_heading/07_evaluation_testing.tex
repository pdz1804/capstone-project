...
\begin{table}[H]
    ...
    \begin{tabular}{lrr}
        \toprule
        \textbf{Dataset Slice} & \textbf{Files} & \textbf{Avg Size (KB)} \\
        \midrule
        OfficeDocBench & 43 & 31.4 \\
        Pandoc (DOCX/PPTX) & 91 & 22.8 \\
        DECO XLSX & 50 & 242.1 \\
        \bottomrule
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \begin{tabular}{lrr}
        \toprule
        \textbf{Format} & \textbf{Files} & \textbf{Avg Size (KB)} \\
        \midrule
        DOCX & 101 & 21.4 \\
        PPTX & 27 & 45.3 \\
        XLSX & 56 & 217.0 \\
