...
\begin{table}[H]
    ...
    \begin{tabular}{p{3.0cm}p{3.3cm}p{3.5cm}p{3.7cm}p{3.5cm}}
        ...
        \midrule
        OmniDocBench & PDF parsing and structure extraction & Hugging Face\tablefootnote{OpenDataLab. (2024, December 10). opendatalab/OmniDocBench. Hugging Face. Retrieved June 24, 2026, from \url{https://huggingface.co/datasets/opendatalab/OmniDocBench}}; GitHub\tablefootnote{OpenDataLab. (n.d.). OmniDocBench: A comprehensive benchmark for document parsing and evaluation. GitHub. Retrieved June 24, 2026, from \url{https://github.com/opendatalab/OmniDocBench}} & 1,650 annotated page images & $\sim$1.55 GB public dataset; $\sim$985 KB/page \\
        OfficeDocBench & Office document parsing benchmark & AILANG benchmark\tablefootnote{Sunholo. (n.d.). Benchmarks. AILANG Parse. Retrieved June 24, 2026, from \url{https://www.sunholo.com/ailang-parse/benchmarks.html}}; GitHub\tablefootnote{Sunholo Data. (n.d.). ailang-parse: Universal document parsing and generation in AILANG. GitHub. Retrieved June 24, 2026, from \url{https://github.com/sunholo-data/ailang-parse}} & 43 files; DOCX pages, PPTX slides, XLSX sheets & Avg 31.4 KB; median 23.0 KB \\
        Pandoc DOCX/PPTX & Augmented Office-style parsing evaluation & Pandoc GitHub\tablefootnote{MacFarlane, J. (n.d.). Pandoc: Universal markup converter. GitHub. Retrieved June 24, 2026, from \url{https://github.com/jgm/pandoc}} & 91 files; pages/slides & DOCX avg 20.2 KB; PPTX avg 33.0 KB \\
        DECO XLSX & Spreadsheet table/layout parsing evaluation & DECO landing page\tablefootnote{Technische Universitaet Dresden. (n.d.). DECO: A dataset for document extraction and conversion. Retrieved June 24, 2026, from \url{https://tud.qucosa.de/en/landing-page/https\%3A\%2F\%2Ftud.qucosa.de\%2Fapi\%2Fqucosa\%253A82977\%2Fmets/}} & 50 spreadsheets; sheets & Avg 242.1 KB; median 71.4 KB \\
