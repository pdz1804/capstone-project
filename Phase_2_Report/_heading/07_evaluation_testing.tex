...
\textbf{BM25 (Sparse Retrieval) - Full Metrics}
...
\textbf{Dense (Semantic Retrieval) - Full Metrics}
...
\textbf{BM25 Image Retrieval - Full Metrics}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{lrr}
        ...
        \midrule
        Mean WER (Word Error Rate) & 16.63\% & Good-typical for Whisper tiny on CPU \\
