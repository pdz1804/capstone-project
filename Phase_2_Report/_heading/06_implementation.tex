...
\begin{table}[H]
    \centering
    \scalebox{0.8}{
    \begin{tabular}{llp{1.6cm}p{3cm}p{4.5cm}rr}
        \toprule
        \textbf{Category} & \textbf{Component} & \textbf{Quantity} & \textbf{Unit Price} & \textbf{Base Calc} & \textbf{Cost} & \textbf{\%} \\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{llllrrr}
        \toprule
        \textbf{Provider} & \textbf{GPU Type} & \textbf{Pricing Model} & \textbf{Pricing Unit} & \textbf{Always-On} & \textbf{50-User} & \textbf{Savings vs AWS} \\
        \midrule
