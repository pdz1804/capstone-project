...
For documents NOT in the custom parser output directories, Docling performs full structural analysis.
...
Documents and indices are organized by user and document ID:
\begin{verbatim}
s3://bk-mind-documents/
  users/{user_id}/
...
This structure ensures that document retrieval and index queries are isolated per user, preventing cross-user data leakage.
