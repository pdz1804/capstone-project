...
Docling analyzes all normalized documents, with intelligent conditional skipping for documents already processed by Stages 3b/3c/3d (via smart deduplication). For documents NOT in the custom parser output directories, Docling performs full structural analysis.
