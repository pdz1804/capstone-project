...
This chapter describes our \textbf{Multimodal Retrieval-Augmented Generation (MRAG) system} which combines large language models with a knowledge database to answer questions with cited sources. This design allows our system to process and retrieve information from diverse HCMUT educational materials while maintaining accuracy and transparency.
