...
You have **four files** in the `Phase_2/Manuscript` folder:
...
| `Manuscript_Analysis_and_Outline.md` | Content extraction from Phase_2/Report | Need to understand what was extracted from report |
