...
% silence package removed - was causing compilation deadlock with MiKTeX
% If csquotes warning appears, it's harmless for this document

% Encoding and Language Settings
\usepackage[utf8]{inputenc}       % Enables UTF-8 encoding
\usepackage[T5]{fontenc}          % Supports Vietnamese characters
\usepackage{pmboxdraw}            % Supports box-drawing characters
...
% Markdown Support
% Removed: markdown package requires shell-escape (security risk)
% Use verbatim for code blocks instead
...
%%%%%%%%%%% Bibliography %%%%%%%%%%%%
% Note: csquotes omitted to avoid T5 encoding warnings with Vietnamese text
...
\setlength{\parskip}{0.4em}       % Paragraph spacing
...
\newgeometry{top=2cm, bottom=2cm, left=2cm, right=2.5cm} % Adjust as needed
...
\textbf{\Large CAPSTONE PROJECT (CO4337)}\\[0.5cm]
\hline
\\[0.4cm]
\textbf{\LARGE BK-MIND: A MULTIMODAL}\\[4pt]
\textbf{\LARGE DATA UNDERSTANDING SYSTEM}\\[4pt]
\textbf{\LARGE FOR ACADEMIC LECTURES}\\[0.5cm]
\hline
\\[0.4cm]
...
\hspace{4 cm} & Committee: & Committee 10CC Computer Science \\
& & Ph.D. Truong Vinh Lan \\
& & M.Sc. Mai Xuan Toan \\
& & Ph.D. Nguyen Quoc Minh \\[0.3cm]
...
\vfill
\begin{center}
{\footnotesize HO CHI MINH CITY, JUNE 2026}
\end{center}
\restoregeometry
\end{titlepage}
...
\newpage
\noindent Signature: \rule{0.5\textwidth}{0.4pt} \hfill Date: \rule{0.25\textwidth}{0.4pt}\\[1em]
\noindent\phantom{Signature: }Nguyen An Khuong, Ph.D.
\newpage

\include{_heading/00_declaration}
\include{_heading/00_acknowledgements}
...
\include{_heading/05_proposed_solution}
\include{_heading/06_implementation}
\include{_heading/07_evaluation_testing}
\include{_heading/08_conclusion}
...
\begin{appendices}
\include{_heading/09_appendices}
\end{appendices}
