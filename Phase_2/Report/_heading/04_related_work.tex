...
\begin{itemize}
    \item Structured document summaries \footnote{Google. (n.d.). NotebookLM summaries, from \url{https://blog.google/technology/ai/notebooklm-summaries/}},
    \item AI-generated flashcards and quizzes for active recall \footnote{Google. (n.d.). NotebookLM learning tools, from \url{https://blog.google/technology/ai/notebooklm-learning-tools/}},
    \item Podcast-style audio overviews generated from uploaded materials, and
    \item Narrated visual summaries similar to lecture recap videos \footnote{Google. (2024, September 11). NotebookLM now lets you listen to a conversation about your sources, from \url{https://blog.google/technology/ai/notebooklm-audio-overviews/}}
\end{itemize}
...
NotebookLM enforces privacy by not using uploaded materials for model training and storing sources privately unless shared \footnote{Google. (n.d.). NotebookLM privacy, from \url{https://notebooklm.google.com/privacy}}. This makes the tool suitable for proprietary lecture materials. The system is deployed on both web and mobile platforms, supporting flexible access \footnote{Google. (n.d.). NotebookLM mobile app, from \url{https://blog.google/technology/apps/notebooklm-mobile/}}.
