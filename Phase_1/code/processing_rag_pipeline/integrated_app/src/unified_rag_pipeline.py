...
1. Document Processing (from Phase_1/code/processing_rag_pipeline/unified_processor)
...
2. Information Retrieval (from Phase_1/code/retrieval/production_retrieval)
