...
- 📄 **Document Processing Pipeline** (`processing_rag_pipeline/unified_processor`) - Ingestion, normalization, and processing
- 🔍 **Information Retrieval Pipeline** (`retrieval/colpali_modal_retrieval`) - Multiple retrieval strategies and evaluation
...
cd Phase_1/code/processing_rag_pipeline/integrated_app
...
```
Phase_1/code/processing_rag_pipeline/integrated_app/
...
- **QPhu**: Document processing pipeline (Phase_1/code/processing_rag_pipeline/unified_processor)
- **NKhoi**: Information retrieval pipeline (Phase_1/code/retrieval/production_retrieval)
