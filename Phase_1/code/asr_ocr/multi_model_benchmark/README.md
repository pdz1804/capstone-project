...
# Phase_1/code/asr_ocr/multi_model_benchmark: Multimodal Lecture Processing Pipeline
...
```
Phase_1/code/asr_ocr/multi_model_benchmark/
...
cd Phase_1/code/asr_ocr/multi_model_benchmark
```
