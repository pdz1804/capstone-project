...
\begin{center}
\begin{tabular}{c}
\textbf{{\Large SPECIALIZED PROJECT (CO4029)}}\\
\hline
\\
\\
\vspace{6pt}
\textbf{{\LARGE BK-MInD: A Multimodal}}\\[4pt]
\textbf{{\LARGE Data Understanding System for HCMUT Lectures}}\\
\vspace{6pt}
\\
\hline
\end{tabular}
...
\begin{table}[h]
\begin{tabular}{rrll}
\hspace{5 cm} & Supervisors: & Nguyen An Khuong, PhD & \\
