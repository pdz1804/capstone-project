...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/pdz/20-textchunk.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/pdz/21-visualemb.png}
...
The retrieval layer unifies these two streams. The index supports \textbf{Hybrid}, allowing for keyword precision and semantic recall. The Text and Visual indices can be queried simultaneously to return both relevant text snippets and their corresponding visual page contexts.
