...
Recent developments in Multimodal Large Language Models (MLLMs) provide potential solutions to these challenges. Models and applications such as Gemini 3\footnote{\url{https://deepmind.google/models/gemini/}} and NotebookLM\footnote{\url{https://blog.google/technology/ai/notebooklm-google-ai/}} demonstrate capabilities for processing and reasoning across text, image, and audio modalities. These advances suggest the feasibility of developing educational systems that can process lecture materials across multiple modalities with minimal information loss. This technical foundation motivates our investigation into integrating Retrieval-Augmented Generation (RAG) techniques with multimodal representation learning for educational applications. The proposed system aims to address both institutional content management needs at HCMUT and the broader requirements of self-directed multimodal learning.\section{Objectives}
