...
\begin{itemize}
    \item RAG and its adaptation to multimodal contexts.
    ...
    \item OCR and ASR for extracting multimodal input data.
...
\begin{itemize}
    ...
    \item \textbf{Chapter 2: Preliminary Study} – Presents foundational knowledge, key theories, and tools relevant to multimodal retrieval and LLMs.
