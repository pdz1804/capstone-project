...
% Research & Setup
\ganttbar[bar/.style={fill=blue!30}]{Literature Review \& Setup}{1}{3} \\
\ganttbar[bar/.style={fill=blue!30}]{VLM \& ASR Survey}{2}{4} \\

% Baseline Development
\ganttbar[bar/.style={fill=green!40}]{ASR \& OCR Trials}{3}{6} \\
\ganttbar[bar/.style={fill=green!40}]{Retrieval Exp. (Sparse/Dense)}{4}{8} \\
\ganttbar[bar/.style={fill=orange!40}]{Pipeline v1 Integration}{6}{10} \\

% Deliverables
\ganttbar[bar/.style={fill=purple!30}]{Application Prototype}{8}{10} \\
...
The planned work schedule for Phase 2 is structured across twelve weeks, encompassing system integration, large-scale dataset construction, hybrid retrieval implementation, and comprehensive evaluation activities.
...
% Optimization Track
\ganttbar[bar/.style={fill=blue!40}]{\textbf{Optimization:} Retrieval Image-based Exp.}{13}{16} \\
\ganttbar[bar/.style={fill=blue!40}]{\textbf{Optimization:} ColBERT/ColPali Indexing}{14}{17} \\
\ganttbar[bar/.style={fill=blue!40}]{\textbf{Optimization:} Response Quality Tuning}{16}{20} \\

% Document Processor Track
\ganttbar[bar/.style={fill=purple!40}]{\textbf{Doc Processor:} Spreadsheets Support}{13}{16} \\
\ganttbar[bar/.style={fill=purple!40}]{\textbf{Doc Processor:} Video Handling}{16}{19} \\

% Multi-Agent Track
\ganttbar[bar/.style={fill=teal!40}]{\textbf{Multi-Agent:} Rerouting}{16}{19} \\
\ganttbar[bar/.style={fill=teal!40}]{\textbf{Multi-Agent:} Hallucination Reduction}{18}{22} \\

% User Features Track
\ganttbar[bar/.style={fill=yellow!50}]{\textbf{User Features:} Lecture Summarization}{17}{20} \\
\ganttbar[bar/.style={fill=yellow!50}]{\textbf{User Features:} Personalized Preference}{19}{22} \\

% Deployment Track
\ganttbar[bar/.style={fill=red!40}]{\textbf{Deployment (optional)}}{21}{24} \\

% Defense Track
\ganttbar[bar/.style={fill=orange!50}]{\textbf{Defense:} Thesis Finalization}{22}{24} \\
\ganttbar[bar/.style={fill=orange!70}]{\textbf{Defense:} Defense Preparation}{24}{25} \\

% % Milestones
% \ganttmilestone{M1: Core Optimization Ready}{17} \\
% \ganttmilestone{M2: Feature \& Agent Freeze}{22} \\
% \ganttmilestone{M3: System Deployed (Cloud)}{24} \\
% \ganttmilestone{M4: Defense Submission}{25}

\end{ganttchart}
\caption{Phase 2 Planned Timeline with Parallel Tracks and Milestone Checkpoints}
\end{figure}
