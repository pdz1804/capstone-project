...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Surveyed state-of-the-art Vision Language Models (VLMs), OCR technologies (Tesseract, Mistral OCR), and ASR systems (PhoWhisper, Whisper), informing technology selection decisions.
    \end{itemize}
...
% Group 1: Research & Setup
\ganttgroup{Research \& Setup}{1}{4} \\
\ganttbar{Lit Review \& Setup}{1}{3} \\
\ganttbar[bar/.style={fill=blue!30}]{VLM \& ASR Survey}{2}{4} \\

% Group 2: Pipeline Development
\ganttgroup{Baseline Development}{3}{9} \\
...
\ganttgroup{Deliverables}{8}{12} \\
\ganttbar{UI/API Design}{8}{10} \\
\ganttbar{Report \& Presentation}{10}{12}

\end{ganttchart}
\caption{Phase 1 Implementation Timeline: Completed work showing the parallelization of research, processing, and experimental tracks across the 12-week development period.}
\end{figure}
...
\subsection{Phase 2 Planned Work Schedule}
...
% Evaluation & Writing
\ganttgroup{Academic Eval \& Writing}{18}{24} \\
\ganttbar[bar/.style={fill=yellow!50}]{Benchmark \& RQ Analysis}{19}{22} \\
\ganttbar[bar/.style={fill=gray!30}]{Thesis: Final Writing}{18}{23} \\
\ganttbar[bar/.style={fill=red!40}]{Defense Preparation}{24}{25}

\end{ganttchart}
\caption{Phase 2 Planned Timeline: Proposed schedule highlighting the strategic overlap between multimodal backend development, frontend integration, and academic evaluation across the 13-week implementation period.}
\end{figure}