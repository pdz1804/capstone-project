...
\subsection{Advanced Document Parsing: Docling}
...
\subsection{Audio Transcription: Whisper}
...
\subsection{Advanced Visual Retrieval: ColQwen Architecture}
...
\begin{itemize}
    \item \textbf{Extraction}: Raw video files (e.g., MP4) are processed using \textbf{MoviePy}. This extractor separates the visual stream from the audio stream, outputting a \texttt{.WAV} file for transcription and an optional image thumbnail.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/pdz/27-chunkemb.png}
