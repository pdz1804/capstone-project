...
\begin{itemize}
    \item \textbf{Optical Character Recognition}: For standard scanned text, high-performance OCR engines recover the textual layer.
    \item \textbf{Vision-Language Models}: For complex layouts, Docling leverages Vision-Language Models. These models "look" at the page to understand semantic structures that regex or rule-based parsers miss, such as distinguishing a figure caption from the main body text.
\end{itemize}
