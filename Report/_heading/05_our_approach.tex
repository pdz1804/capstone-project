...
To extend the system's retrieval capabilities beyond static documents, the pipeline integrates \textbf{OpenAI Whisper}, a robust Automatic Speech Recognition (ASR) system. This component allows the RAG engine to \textit{listen} to multimedia content, converting spoken words into structured, searchable text.
