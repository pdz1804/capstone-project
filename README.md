...
#### **QPhu: Advanced Document Processing** (`Week0506_QPhu_Processor/`)
State-of-the-art multimodal processing using IBM's Docling framework.

**Capabilities**:
- **Layout Analysis**: Reading order detection, table structure recognition
- **Visual Understanding**: GraniteDocling VLM integration
- **Multi-OCR Support**: Tesseract, EasyOCR, RapidOCR
- **Audio Transcription**: Integrated ASR for lecture recordings
- **Structured Export**: Markdown, JSON, HTML with preserved formatting

**Optimization**: GPU acceleration, batch processing, comprehensive error handling
...
**Team**: MKhoi (Processing), NKhoi (Retrieval), QPhu (RAG/Integration)
