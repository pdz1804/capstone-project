...
$$y[m,n] = \sum\_{i=-\infty}^{\infty} \sum\_{j=-\infty}^{\infty} x[i,j] \cdot h[m-i,n-j]$$

### 2. Attention Mechanisms

The attention weight is calculated as: $$\alpha\_{ij} = \frac{\exp(e\_{ij})}{\sum\_{k=1}^{T\_x} \exp(e\_{ik})}$$
