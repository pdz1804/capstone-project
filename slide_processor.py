...
class SlideOCR:
    ...
    def extract_text_tesseract(self, image_path, lang='vie+eng'):
        ...
        Args:
            ...
            lang (str): Language code(s) for OCR (default: 'vie+eng' for Vietnamese and English)
    ...
    def _get_organized_path(self, input_path, output_dir, page=None):
        """
        Generate an organized output path for the OCR results.
        
        Args:
            input_path (Path): Path to the input file
            output_dir (Path): Base output directory
            page (int, optional): Page number for multi-page documents
            
        Returns:
            Path: Organized output path
        """
    ...
    def process_slides(self, input_paths, output_dir=None):
        """
        Process multiple slide images or PDFs with OCR and organize results.
        
        Args:
            input_paths (list): List of paths to slide images or PDFs
            output_dir (str, optional): Output directory for results
            
        Returns:
            list: List of dictionaries containing OCR results
        """
