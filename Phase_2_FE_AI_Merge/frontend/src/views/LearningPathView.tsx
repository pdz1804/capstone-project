          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 focus:ring-2 focus:ring-indigo-500/30 outline-none"
                />
              </div>
              <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <button
                ...
                className="px-6 py-3 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-700 disabled:opacity-60 flex items-center justify-center gap-2 shrink-0"
              >
